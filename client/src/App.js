    ...
    <div className="App container">
      ...
      <div className="Information">
        <form action="">
          ...
          <div className="mb-3">
            <label html="age" className="form-label">
              Age:
            </label>
            <input
              type="number"
          ...
          <div className="mb-3">
            <label html="country" className="form-label">
              Country:
            </label>
            <input
              type="text"
          ...
          <div className="mb-3">
            <label html="position" className="form-label">
              Position:
            </label>
            <input
              type="text"
          ...
          <div className="mb-3">
            <label html="wage" className="form-label">
              Wage:
            </label>
            <input
              type="number"
